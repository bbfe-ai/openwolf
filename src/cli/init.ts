  ...
  const templates: Record<string, string> = {
    ...
    "config.json": JSON.stringify({
      ...
      openwolf: {
        ...
        memory: { consolidation_after_days: 7, max_entries_before_consolidation: 200, log_edits: false },
  ...
  if (sourceDir) {
    ...
    for (const file of hookFiles) {
      ...
      if (fs.existsSync(src)) {
        ...
        fs.writeFileSync(dest, loaderContent, "utf-8");
        copiedAny = true;
      }
    }
  }
